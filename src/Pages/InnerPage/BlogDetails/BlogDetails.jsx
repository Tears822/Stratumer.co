...
import { serviceCategories } from "../ServiceDetails/serviceDetailsData";

const popularThumbs = [itemthumb, itemthumb2, itemthumb3];

const BlogDetails = () => {
  const { pathname } = useLocation();
  const post = blogPosts[pathname] || blogPosts["/blog_details"];
            ...
            <div className="col-span-2">
              <div className="border-l border-b border-BorderColor2-0 rounded-md">
                ...
                <div className="px-4 sm:px-8 ml-8 bg-white shadow-cases rounded-b-md rounded-ss-md -mt-[50px] relative z-10">
                  ...
                  <h3 className="font-Rajdhani font-bold text-left text-lg sm:text-2xl text-HeadingColor-0 mt-7 mb-5">
                    {post.title}
                  </h3>
                ...
                <div className="px-4 sm:px-8">
                  ...
                  <h4 className="font-Rajdhani font-bold text-left text-lg sm:text-[28px] text-HeadingColor-0 mt-14 mb-4">
                    {post.sectionTitle}
                  </h4>
                  ...
                  <ul className="flex flex-col gap-[14px] mt-7">
                    {post.checklist.map((item) => (
                      <li
                        key={item}
                        className="flex gap-3 items-center font-Nunito font-light text-TextColor2-0"
                      >
                        <FaCircleCheck
                          size={"20"}
                  ...
                  <h4 className="font-Rajdhani font-bold text-left text-lg sm:text-[28px] text-HeadingColor-0 mt-10 mb-4">
                    {post.secondTitle}
                  </h4>
            ...
            <div className="col-span-2 lg:col-span-1">
                  ...
                  <Link to={item.path} key={item.path}>
                    <button className="group flex gap-4 mb-6">
                      <div className="rounded overflow-hidden">
                        <img draggable="false" src={popularThumbs[index]} />
                      </div>
              ...
              <div className="bg-[#f3f4f8] rounded-md px-4 sm:px-8 lg:px-6 xl:px-8 pt-7 pb-10 mb-7">
                ...
                <ul className="inline-block">
                  {["IT Solution", "Marketing", "Cloud", "Web", "Security", "Technology"].map(
                    (tag) => (
                      <li
                        key={tag}
                        className="inline-block mr-[10px] mb-[10px]"
                      >
                        <Link to={"/blog_grid"}>
